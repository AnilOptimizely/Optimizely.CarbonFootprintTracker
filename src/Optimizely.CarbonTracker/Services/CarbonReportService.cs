...
public class CarbonReportService(
    IPageAnalysisService pageAnalyzer,
    ICarbonCalculatorService carbonCalculator,
    ILogger<CarbonReportService> logger) : ICarbonReportService
{
    private readonly IPageAnalysisService _pageAnalyzer = pageAnalyzer;
    private readonly ICarbonCalculatorService _carbonCalculator = carbonCalculator;
    private readonly ILogger<CarbonReportService> _logger = logger;
